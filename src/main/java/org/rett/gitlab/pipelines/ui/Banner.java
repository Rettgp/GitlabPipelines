 ...
 * @author PPI AG
 */
//copied from com.intellij.openapi.ui.Banner as that class is package-private
public class Banner extends NonOpaquePanel implements PropertyChangeListener {
    private int myBannerMinHeight;
    private final JComponent myText = new Banner.MyText();
    ...
    Banner() {
        ...
        myProjectIcon.setBorder(JBUI.Borders.empty(0, 12, 0, 4));
    ...
    public void setText(final String @NotNull ... text) {
        ...
        for (int i = 0; i < text.length; i++) {
            ...
            eachLabel.setBorder(JBUI.Borders.emptyRight(5));
            ...
            if (i < text.length - 1) {
                ...
                eachIcon.setBorder(JBUI.Borders.emptyRight(5));
                myText.add(eachIcon);
            }
        }
    }
